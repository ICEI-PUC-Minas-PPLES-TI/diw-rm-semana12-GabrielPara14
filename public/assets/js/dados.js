  ...
  noticias: [
    {
      ...
      destaque: true,
      data: "2025-03-30",
      imagem_principal: "assets/img/mobilidade.jpeg",
      imagens_complementares: [
        { id: 1, src: "assets/img/mobilidade.jpeg", descricao: "Corredor exclusivo para ônibus" },
        { id: 2, src: "assets/img/mobilidade2.jpeg", descricao: "Ciclovia em área central" },
        { id: 3, src: "assets/img/mobilidade3.jpeg", descricao: "Requalificação de calçadas" }
      ]
    },
    {
      id: 2,
      ...
      destaque: false,
      data: "2025-03-28",
      imagem_principal: "assets/img/6g.jpeg",
      imagens_complementares: [
        { id: 1, src: "assets/img/6g1.jpeg", descricao: "Teste de rede 6G em laboratório" },
        { id: 2, src: "assets/img/6g2.jpeg", descricao: "Equipamentos para 6G" }
      ]
    },
    {
      id: 3,
      ...
      destaque: true,
      data: "2025-03-27",
      imagem_principal: "assets/img/imagem_show.jpeg",
      imagens_complementares: [
        { id: 1, src: "assets/img/show1.jpeg", descricao: "Público no festival" },
        { id: 2, src: "assets/img/show2.jpeg", descricao: "Artista se apresentando" }
      ]
    }
  ]
};